    ...
    for row_data in BOARD_LAYOUT:
        for square_data in row_data:
            ...
            board[row][col] = Square(
                word_mult=word_mult, board_color=color, is_start=is_start
            )
...
def print_literaki_board(board):
    ...
    print(
        "L(ColorInitial) = Letter Bonus for matching Color (e.g., LO = Orange square for letter bonus)"
    )
...
if __name__ == "__main__":
    ...
    print(
        "Properties of square (0,3) (Orange Letter Bonus):", literaki_game_board[0][3]
    )
